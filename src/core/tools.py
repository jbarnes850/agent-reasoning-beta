...
class VisualizationTools:
    ...
    @staticmethod
    @measure_performance
    async def prepare_metrics_data(
...
class AgentTools:
    ...
    async def validate_reasoning_path(
        ...
        low_confidence_nodes = [
            (i, node) for i, node in enumerate(path.nodes)

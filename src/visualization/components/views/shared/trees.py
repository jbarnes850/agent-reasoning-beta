...
class TreeVisualizer:
    ...
    async def visualize_reasoning_path(
        ...
        self._layout = nx.spring_layout(
            self._graph, k=self.config.MIN_NODE_DISTANCE / 1000, iterations=50
        )
    ...
    def _add_agent_nodes(self, fig: go.Figure, agents: List[Dict[str, Any]]) -> None:
    ...
    def _add_interaction_edges(
        self, fig: go.Figure, interactions: List[Dict[str, Any]]
    ) -> None:
